...
public class EMR_MainActivity extends Activity {
    ...
    public void login(String un, String pw){
        ...
        try{
            ...
            nameValuePairs.add(new BasicNameValuePair("password", pw));
             ...
             HttpPost httppost = new HttpPost("http://10.0.2.2/EMR/login.php");
        ...
        try{
            ...
            if(new String(baf.toByteArray()).equals("1")){
            	display.setText("Log in success!");
            	Intent it = new Intent(this, patientList.class);
				startActivity(it);           
            	display.setText(""); 	
            }
            else{display.setText("Wrong username or password");}
